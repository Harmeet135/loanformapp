...
const Details = () => {
  ...
  const deleteData = async (id) => {
    const deleted = await fetch(
      `https://loanapplicationform.herokuapp.com/delete/${id}`,
      {
        method: "DELETE",
        headers: {
          "Content-Type": "application/json",
  ...
  return (
    <div className="container mt-3">
      <h1 style={{ fontWeight: 400 }}>Welcome {getdata.name}</h1>
        ...
        <CardContent>
          ...
          <div className="row">
            <div className="left_view col-lg-6 col-md-6 col-12">
              ...
              <p className="mt-3">
                <WorkIcon />
                Address: <span>{getdata.address}</span>
              </p>
            </div>
            <div className="right_view  col-lg-6 col-md-6 col-12">
              ...
              <p className="mt-3">
                <LocationOnIcon />
                location: <span>{getdata.state}</span>
              </p>
              <p className="mt-3">
                Loan Amount : <span>{getdata.loan}$</span>
              </p>
            </div>
          </div>
        </CardContent>
